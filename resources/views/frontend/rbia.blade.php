...
@section('css')
<link rel="stylesheet" href="{{ asset('css/inverters.css') }}">
@endsection
 ...
 <section class="row">
     <div class="imgwrapper">
         <img class="img" src="./solar img/Chint-10-KTL-On-Grid-Inverter.jpg">
         <div class="text">
     ...
     <div class="imgwrapper">
         <img class="img2" src="./solar img/High-Frequency-Off-grid-Solar-power-Inverter.webp">
         <div class="text2">
